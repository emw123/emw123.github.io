...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for key in periodic_table_dict:
        symbol_quantity_list = periodic_table_dict[key]
        symbol = symbol_quantity_list[0]
        quantity = symbol_quantity_list[1]
        atomic_mass = ATOMIC_MASS_INDEX
        molar_mass = atomic_mass(symbol) * quantity
        print(molar_mass) 
    ...
    pass
def main(formula, atomic_mass, periodic_table_dict, symbol_quantity_list):
    formula = input('Enter the molecular formula of the sample: ')
    atomic_mass = input('Enter the mass in grams of the sample: ')
    make_periodic_table()
    parse_formula(formula, periodic_table_dict)
    compute_molar_mass(symbol_quantity_list, periodic_table_dict, atomic_mass)

if __name__ == "__main__":
    main("formula","atomic_mass","periodic_table_dict", "symbol_quantity_list")